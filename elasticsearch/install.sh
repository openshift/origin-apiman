...
#/usr/share/elasticsearch/bin/plugin -i io.fabric8.elasticsearch/openshift-elasticsearch-plugin/0.14 -url http://file.rdu.redhat.com/ewolinet/openshift-elasticsearch-plugin-0.14-SNAPSHOT.zip
